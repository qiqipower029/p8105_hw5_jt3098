...
# Make a function to do the prop.test and then get tidied
prop_test_tidy = function(location) {
  result = 
    prop.test(x = homicide_data_summary$n_unsolved[homicide_data_summary$city_state == location],
              n = homicide_data_summary$n_homicide[homicide_data_summary$city_state == location],
...
# Run this function for each city
